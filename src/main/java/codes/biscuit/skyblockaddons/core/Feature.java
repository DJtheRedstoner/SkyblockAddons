...
//    HIDE_DURABILITY(9, Message.SETTING_HIDE_DURABILITY), // Removed, added to Skyblock.
    ...
    SHOW_TIME_REMAINING_ABOVE_BREWING_STANDS(99, Message.SETTING_SHOW_TIME_REMAINING_ABOVE_BREWING_STANDS, new GuiFeatureData(ChatFormatting.GREEN), false, EnumUtils.FeatureSetting.COLOR_BY_TIME_REMAINING),
    COLOR_BY_TIME_REMAINING(100, Message.SETTING_COLOR_BY_TIME_REMAINING, false),
    ...
    private static final Set<Feature> SETTINGS = Sets.newHashSet(DOUBLE_DROP_IN_OTHER_GAMES,
            ...
            REPEAT_SLAYER_BOSS_WARNING, COLOR_BY_TIME_REMAINING);
